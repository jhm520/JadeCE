...
public:
	...
	UFUNCTION(BlueprintCallable, Category = "GAS")
	static void CancelAbilityOnActorByClass(AActor* Actor, TSubclassOf<UGameplayAbility> InAbilityClass);

	static FGameplayAbilitySpec* FindAbilitySpecByTag(UAbilitySystemComponent* InASC, FGameplayTag InAbilityTag);

	UFUNCTION(BlueprintCallable, Category = "GAS")
	static void CancelAbilityOnActorByTag(AActor* Actor, FGameplayTag InAbilityTag);
