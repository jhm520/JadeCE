...
#include "ManipulationComponent_ScaleAxis.generated.h"
...
class NETVRKCREATIVEEDITORUTILITY_API UManipulationComponent_ScaleAxis : public UManipulationComponent_Mouse
{
	GENERATED_BODY()
#pragma region Framework
public:
	UManipulationComponent_ScaleAxis();
...
#pragma region Manipulation
	...
	UPROPERTY()
	FVector2D CachedMousePosition_ManipulationStart;

	UPROPERTY(EditAnywhere, BlueprintReadOnly, Category = "Manipulation")
	float ScaleSpeed = 0.01f;

	UPROPERTY(EditAnywhere, BlueprintReadOnly, Category = "Manipulation")
	bool bScaleAllAxes = false;

	UPROPERTY(EditAnywhere, BlueprintReadOnly, Category = "Manipulation")
	bool bSnapEnabled = true;

	UPROPERTY(EditAnywhere, BlueprintReadOnly, Category = "Manipulation")
	float SnapScaleIncrement = 0.1f;
	...
	virtual void SetSnapIncrement(float InSnapIncrement) override { SnapScaleIncrement = InSnapIncrement; }
